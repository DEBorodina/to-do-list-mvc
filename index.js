...
function card(){
    ...
    <div class="card">
      <div class="card__content">
        <button class="card__delete-button"><img class="card__delete-icon" src="white-trash-icon.png"></button>
        <h1 class="card__title">Sleep</h1>
        <h2 class="card__time">22:00</h2>
        <p class="card__text">I need to go to bed earlier</p>
        <label class="label">
    ...
    <header id='header' class='header'>
     ...
     <div class="header__content">
      <svg class="diagram" height="120" width="120">
          ...
          <circle class='diagram__completed' cy="60" cx="60" r="50" stroke-dasharray="${k/(k+i)*314} ${(1-(k/(k+i)))*314}" stroke-dashoffset="78.5"></circle>
          <text class='diagram__text' x="${(k/(k+i)*100===100)?30:45-(k/(k+i)*100>9&&7)}" y="70"> ${Math.round(k/(k+i)*100)}% </text>
      </svg>
      <div class="header__description">
         <p class='header__text'>${k} - is completed</p>
         <p class='header__text'>${i} - in progress</p>
      </div>
              ...
              <div class="mt-3 text-center sm:mt-2 sm:ml-4 sm:text-left">
                ...
                <div class="mt-2">
                  <div class="mt-7">
                    ...
                    <input class="modal__input" type="text" id="inputTime" placeholder="Enter time">
...
function printApp(){
    ...
    document.querySelector("#todoList").insertAdjacentHTML('afterbegin',card());
    document.querySelector("#todoList").insertAdjacentHTML('afterbegin',card());
    document.querySelector("#todoList").insertAdjacentHTML('afterbegin',card());
    document.querySelector("#todoList").insertAdjacentHTML('afterbegin',card());
    document.querySelector("#todoList").insertAdjacentHTML('afterbegin',card());
